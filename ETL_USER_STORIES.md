...
**Acceptance Criteria:**
- Single CLI execution: `poetry run espn-extract player-extract --output_dir ./output`
...
poetry run espn-extract --output_dir ./output

# Force full extraction (bypass GraphQL even if available)
poetry run espn-extract --output_dir ./output --force-full-extraction

# Custom batch size
poetry run espn-extract --output_dir ./output --batch-size 50
```
