...
class League(BaseLeague):
    ...
    def __init__(
        ...
        self._box_score_class: Any = None
    ...
    def _fetch_league(self, SettingsClass=BaseSettings):
        data = super()._fetch_league(SettingsClass)
        self._fetch_players()
        return data

    def _fetch_teams(self, data, TeamClass=Team, pro_schedule=None):
    ...
    def scoreboard(self, matchupPeriod: int | None = None) -> List[Matchup]:
    ...
    def recent_activity(
        self, size: int = 25, msg_type: str = "", offset: int = 0
    ) -> List[Activity]:
